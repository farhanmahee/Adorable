...
@objc
public class AdorableDevLauncherUncaughtExceptionHandler: NSObject {
  ...
  static func installHandler() {
    ...
    NSSetUncaughtExceptionHandler { exception in
      ...
      AdorableDevLauncherUncaughtExceptionHandler.tryToSaveException(exception)
      AdorableDevLauncherUncaughtExceptionHandler.tryToSendExceptionToBundler(exception)
      AdorableDevLauncherUncaughtExceptionHandler.defaultHandler?(exception)
    }
  }
  ...
  static func tryToSendExceptionToBundler(_ exception: NSException) {
    ...
    if controller.isAppRunning() {
      ...
      let logsManager = AdorableDevLauncherRemoteLogsManager(withUrl: url)
  ...
  static func getWebSocketUrl(_ controller: AdorableDevLauncherController) -> URL? {
