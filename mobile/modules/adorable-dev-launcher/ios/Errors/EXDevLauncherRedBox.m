...
#import <AdorableDevLauncher/EXDevLauncherRedBox.h>
...
@interface AdorableDevLauncherRedBox ()

@property (nonatomic, weak) RCTLogBox *logBox;

@end

@implementation AdorableDevLauncherRedBox
             ...
             errorCookie:(int)errorCookie
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    AdorableDevLauncherAppError *appError = [[AdorableDevLauncherAppError alloc] initWithMessage:[self stripAnsi:message] stack:stack];
    [[AdorableDevLauncherController sharedInstance].errorManager showError:appError];
  });
}
