...
#import <AdorableDevLauncher/RCTCxxBridge+Private.h>
...
@implementation AdorableDevLauncherRCTCxxBridge

- (instancetype)initWithParentBridge:(RCTBridge *)bridge
{
  if ((self = [super initWithParentBridge:bridge])) {
    RCTBridge *appBridge = [AdorableDevLauncherController sharedInstance].appBridge;
...
- (NSArray<Class> *)filterModuleList:(NSArray<Class> *)modules
{
  NSArray<NSString *> *allowedModules = @[
    ...
    @"AdorableDevLauncherDevMenuExtensions"
  ];
...
@implementation AdorableDevLauncherRCTBridge

- (Class)bridgeClass
{
  return [AdorableDevLauncherRCTCxxBridge class];
}
