...
class DevLauncherViewModel: ObservableObject {
  ...
  @Published var currentError: AdorableDevLauncherAppError?
  @Published var showingCrashReport = false
  @Published var showingErrorAlert = false
  @Published var errorAlertMessage = ""
  @Published var storedCrashInstance: AdorableDevLauncherErrorInstance?
  ...
  private func loadRecentlyOpenedApps() {
    let apps = AdorableDevLauncherController.sharedInstance().recentlyOpenedAppsRegistry.recentlyOpenedApps()
  ...
  func openApp(url: String) {
    ...
    AdorableDevLauncherController.sharedInstance().loadApp(
      bundleUrl,
      onSuccess: nil,
  ...
  func clearRecentlyOpenedApps() {
    AdorableDevLauncherController.sharedInstance().clearRecentlyOpenedApps()
  ...
  func showError(_ error: AdorableDevLauncherAppError) {
    currentError = error
  }
  ...
  func showCrashReport() {
    if let storedCrashInstance {
      let error = AdorableDevLauncherAppError(message: storedCrashInstance.message, stack: nil)
      currentError = error
  ...
  func checkForStoredCrashes() {
    let registry = AdorableDevLauncherErrorRegistry()
